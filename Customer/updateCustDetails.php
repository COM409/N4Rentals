			...
			<div class="row">
				<div class="col-lg-6 col-md-6">
					<div class="well bs-component">
						<form method="POST" action="updateCustomerDetails.php"  class="form-horizontal">
							<h4><b>Update Information:</b></h4>
							<p>You can update your contact address etc. here by changing the details below and clicking Update!</p>
							<fieldset>
							
									<div class="form-group">
										<label for="inputFName" class="col-lg-6 col-md-6 control-label">ID:</label>
										<div class="col-lg-6 col-md-6">
											<input type="text" class="form-control" value="<?php echo $row["id"]?>" name="custFirstName" placeholder="Firstname">
										</div>
									</div>
									
									<div class="form-group">
										<label for="inputFName" class="col-lg-6 col-md-6 control-label">Firstname:</label>
										<div class="col-lg-6 col-md-6">
									...
									<div class="form-group">
										<label for="inputLName" class="col-lg-6 col-md-6 control-label">Lastname:</label>
										<div class="col-lg-6 col-md-6">
									...
									<div class="form-group">
										<label for="inputAddress" class="col-lg-6 col-md-6 control-label">Address:</label>
										<div class="col-lg-6 col-md-6">
									...
									<div class="form-group">
										<label for="inputTown" class="col-lg-6 col-md-6 control-label">Town/City:</label>
										<div class="col-lg-6 col-md-6">
									...
									<div class="form-group">
										<label for="inputCounty" class="col-lg-6 col-md-6 control-label">County:</label>
										<div class="col-lg-6 col-md-6">
									...
									<div class="form-group">
										<label for="inputPCode" class="col-lg-6 col-md-6 control-label">Postcode:</label>
										<div class="col-lg-6 col-md-6">
									...
									<div class="form-group">
										<label for="inputCountry" class="col-lg-6 col-md-6 control-label">Country:</label>
										<div class="col-lg-6 col-md-6">
